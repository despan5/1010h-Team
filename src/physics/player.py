...
class Player(pygame.sprite.Sprite):
    ...
    def __init__(self, SCREEN_HEIGHT):
        ...
        self.rect = self.image.get_rect().inflate(-37.5, -10)  # shrink hitbox size for better collision detection
    ...
    def load_sprites(self, sprite_sheet_path, frame_width, frame_height):
        ...
        num_frames = sheet_width // frame_width  # calculate total frames in the sheet
        frames = []
    ...
    def Update(self, lvlgen, enemies, camera, SCREEN_HEIGHT):
        ...
        if self.is_jumping:
            ...
            self.current_sprites = self.bite_sprites
